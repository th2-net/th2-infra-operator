...
public class EmptyDictionaryLinkResolver implements DictionaryLinkResolver {
    ...
    @Override
    public void resolve(List<Th2Link> linkResources, List<DictionaryLinkage> grpcActiveLinks) {

    }

    @Override
    public void resolve(List<Th2Link> linkResources, List<DictionaryLinkage> grpcActiveLinks, Th2CustomResource... newResources) {
